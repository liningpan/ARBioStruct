...
import edu.rosehulman.liningpan.arbiostruct.detailprotein.ProteinDetailActivity
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener,
    ProteinListFragment.OnProteinItemSelectedListener {
    ...
    override fun onProteinItemSelected(protein: Protein) {
        val proteinDetailIntent = Intent(this, ProteinDetailActivity::class.java)
        protein.putIntent(proteinDetailIntent)
        startActivity(proteinDetailIntent)
    }
}
